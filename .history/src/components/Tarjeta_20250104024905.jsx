                        ...
                        <div>
                            ...
                            <div className="container ">
                                <div className="row d-flex g-3">
                                    ...
                                    <div className="cajita col box d-flex justify-content-center align-items-center flex-column flex-wrap">
                                        <h4>{datos.descripcion}</h4>
                                        <img src={datos.icono} alt={datos.alt} className="img-adjust" />
                                    </div>
                                </div>
                            </div>
                        </div>
