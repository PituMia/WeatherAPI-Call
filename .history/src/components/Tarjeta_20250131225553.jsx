...
const Tarjeta = ({ pintarData, cargandoData, tiempoData, fotoData, errorData }) => {
    if (cargandoData) {
        return <Cargando />;
    }
    if (errorData) {
                ...
                (() => {
                    ...
                    return (
                        <div className= "tarjeta">
                            ...
                            <div className="main d-flex justify-content-center align-items-center flex-column text-center">
                                <h1>{datos.nombre}</h1>
                                <h2>{datos.temp}</h2>
                            </div>
                            <div className="container ">
                                <div className="row d-flex g-3">
                                    <div className="cajita col box d-flex justify-content-center align-items-center flex-column">
                                    ...
                                    <div className="cajita col box d-flex justify-content-between align-items-center flex-column flex-wrap">
                                        <h4>{datos.descripcion}</h4>
                                        <img src={datos.icono} alt={datos.alt} className="img" />
                                    </div>
                                </div>
                            </div>
                        </div>
